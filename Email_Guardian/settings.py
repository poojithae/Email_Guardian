"""
Django settings for Email_Guardian project.
...
SECRET_KEY = 'django-insecure-7*x9v%q#@760b3popmw-7*ymvvv2*9v^6%nn_lixt@_co2&a1g'
...
WSGI_APPLICATION = 'Email_Guardian.wsgi.application'
